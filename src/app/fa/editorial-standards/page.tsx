...
const standards = [
  {
    ...
    body:
      'مطالب عمومی با نام سازمانی PLUCO GROUP تهیه می‌شوند. انتشار یک راهنما به معنی تأیید آن توسط وکیل نام‌برده‌نشده، مرجع دولتی، بانک یا نهاد عمومی نیست. اگر در آینده متخصص مشخصی بازبینی اساسی یک مطلب را انجام دهد، نقش او باید دقیق و قابل‌اثبات معرفی شود.',
  },
  {
